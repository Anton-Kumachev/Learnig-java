...
//Задаём шахматную доску двумерным массивом, метод для правильной нумерации ячеек не на языке массивов,
// а на “шахматном” языке.

public class MainClassExChessboard2 {
    public static String chessBoardCoord ( int a, int b){
        String letters = "abcdefgh";
        String numbers = "87654321";
        if ((a > 7) || (b > 7))
            return null; //если номер за пределами доски, возвращаем значение по умолчанию - null
        else
